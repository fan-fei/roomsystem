...
<head>
	<html:base />
	<title>公寓管理系统--房间管理--新增确认画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/houseManageCreateConfirmExecute">
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../houseManageCreateConfirmBack.do')"></html:button>
			</html:form>
		</div>
