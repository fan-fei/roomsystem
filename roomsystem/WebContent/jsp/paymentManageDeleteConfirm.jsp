...
<head>
	<html:base />
	<title>公寓管理系统--租金管理--删除确认画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/paymentManageDeleteConfirmExecute">
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../paymentManageDeleteConfirmBack.do')"></html:button>
			</html:form>
		</div>
