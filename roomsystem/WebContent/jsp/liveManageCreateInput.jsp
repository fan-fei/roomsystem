					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<span><html:text styleClass="textbox" size="40" name="liveManageForm" property="enter_date" maxlength="10" value="<%= CommonUtility.getSysDate(2) %>" onfocus="calendar()" readonly="true"></html:text></span>
								</logic:notEqual>
							</td>
						</tr>
						<tr>
