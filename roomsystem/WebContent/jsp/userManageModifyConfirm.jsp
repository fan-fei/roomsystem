...
<head>
	<html:base />
	<title>公寓管理系统--帐号管理--修改确认画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/userManageModifyConfirmExecute">
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../userManageModifyConfirmBack.do')"></html:button>
			</html:form>
		</div>
