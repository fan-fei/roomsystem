...
<head>
	<html:base />
	<title>公寓管理系统--租金管理--新增参照画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/paymentManageCreateReferBack">
				...
				<div id="selectlistcontextdiv">
					<table>
						<logic:iterate id="element" name="paymentManageCreateInputReferResult" indexId="index">
							<tr>
								<td width="5%">
									<span><%= index.intValue() + 1 %></span>
								</td>
								<td width="6%">
									<input type="button" class="buttoninlist" value="选择" onclick="formSubmit('../paymentManageCreateReferChoose.do','<bean:write name="index"  />')">
								</td>
								<td width="15%">
