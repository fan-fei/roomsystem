...
<head>
	<html:base />
	<title>公寓管理系统--帐号管理--修改输入画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/userManageModifyInputConfirm">
				<div id="selectinputdiv">
					<table>
						<tr>
							...
							<td>
								<span><bean:write name="userManageForm" property="username" />
								</span>
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../userManageModifyInputBack.do')"></html:button>
			</html:form>
		</div>
