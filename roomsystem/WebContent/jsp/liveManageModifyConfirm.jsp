...
<head>
	<html:base />
	<title>公寓管理系统--住宿管理--修改确认画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/liveManageModifyConfirmExecute">
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../liveManageModifyConfirmBack.do')"></html:button>
			</html:form>
		</div>
