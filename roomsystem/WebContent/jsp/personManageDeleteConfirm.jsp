...
<head>
	<html:base />
	<title>公寓管理系统--人员管理--删除确认画面</title>
...
<body>
	<div id="globaldiv">
		...
		<div id="bodydiv">
			<html:form action="/personManageDeleteConfirmExecute">
				...
				<html:button property="back" value="返回" styleClass="button" onclick="disableDoubleClick();formSubmit('../personManageDeleteConfirmBack.do')"></html:button>
			</html:form>
		</div>
